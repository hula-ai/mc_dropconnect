...
class SegNet(BaseModel):
    ...
    def build_network(self):
        ...
        self.deconv5_3 = conv_layer_dropconnect(self.deconv5_2, "deconv5_3", [3, 3, 512, 512], self.is_training_pl)
        self.deconv5_4 = conv_layer_dropconnect(self.deconv5_3, "deconv5_4", [3, 3, 512, 512], self.is_training_pl)
        ...
        self.deconv4_2 = conv_layer_dropconnect(self.deconv4_1, "deconv4_2", [3, 3, 512, 512], self.is_training_pl,
                                                keep_prob=self.keep_prob_pl)
        self.deconv4_3 = conv_layer_dropconnect(self.deconv4_2, "deconv4_3", [3, 3, 512, 512], self.is_training_pl)
        self.deconv4_4 = conv_layer_dropconnect(self.deconv4_3, "deconv4_4", [3, 3, 512, 256], self.is_training_pl)
        ...
        self.deconv3_2 = conv_layer_dropconnect(self.deconv3_1, "deconv3_2", [3, 3, 256, 256], self.is_training_pl,
                                                keep_prob=self.keep_prob_pl)
        self.deconv3_3 = conv_layer_dropconnect(self.deconv3_2, "deconv3_3", [3, 3, 256, 256], self.is_training_pl)
        self.deconv3_4 = conv_layer_dropconnect(self.deconv3_3, "deconv3_4", [3, 3, 256, 128], self.is_training_pl)
        ...
        self.deconv2_2 = conv_layer_dropconnect(self.deconv2_1, "deconv2_2", [3, 3, 128, 128], self.is_training_pl,
                                                keep_prob=self.keep_prob_pl)
        self.deconv2_3 = conv_layer_dropconnect(self.deconv2_2, "deconv2_3", [3, 3, 128, 64], self.is_training_pl)
        ...
        self.deconv1_1 = up_sampling(self.deconv2_3, self.pool1_index, self.shape_1, self.batch_size_pl,
                                     name="unpool_1")
        self.deconv1_2 = conv_layer_dropconnect(self.deconv1_1, "deconv1_2", [3, 3, 64, 64], self.is_training_pl)
        self.deconv1_3 = conv_layer_dropconnect(self.deconv1_2, "deconv1_3", [3, 3, 64, 64], self.is_training_pl)
